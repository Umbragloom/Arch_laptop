...
export ZSH="/home/umbragloom/.oh-my-zsh"
...
alias pss='neofetch && scrot -t 20 -d 5'
alias gb='sh seeyouspacecowboy.sh'
alias rvim='sudo -E vim'
alias tr='tuir'
alias zr='source .zshrc'
alias cb='cbonsai -i -L 45 -m "Worlds Adrift In Nothingness!"'
alias mx='unimatrix -n -s 96 -c red'
alias mtg='sh ~/Mtgdb.Gui/start.sh'
eval $(thefuck --alias)
...
figlet -f Bloody -k -t 'umbragloom' | lolcat -f
...
export BROWSER=w3m
export EDITOR=vim
export URLVIEWER=urlview
export PATH="/home/umbragloom/.local/bin:$PATH"
